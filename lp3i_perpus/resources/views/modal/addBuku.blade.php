<div class="modal invisible w-full h-screen flex justify-center items-center fixed top-0 left-0 backdrop-blur-2xl">
    <form  class=" fixed px-10 py-14 rounded-xl bg-lp3i bg-opacity-30" action="/store" method="POST">
        ...
        <input class="focus:outline-none placeholder:text-white text-white bg-transparent border-b-white border-b" autocomplete="off" placeholder="Judul buku" type="text" id="nama" name="JudulBuku">
        <input class="focus:outline-none placeholder:text-white text-white  bg-transparent  mt-5 block border-b-white border-b" autocomplete="off" placeholder="Kode" type="text" name="kode" id="email">
        <input class="focus:outline-none placeholder:text-white text-white  bg-transparent  block mt-5  border-b-white border-b" autocomplete="off" placeholder="penulis" type="text" name="penulis" id="penulis">
