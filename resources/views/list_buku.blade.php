    ...
    <div class="flex ">
        <div class="w-[70%] mx-auto mt-20">
            ...
            <div class="flex justify-between items-center mt-16">
                <form action="/list_buku" method="GET">
                    <input type="search" class="border border-black p-2 rounded-full bg-gray-200 text-black placeholder:text-gray-500 focus:outline-none w-60 " placeholder="Search" name="cari">
                </form>
